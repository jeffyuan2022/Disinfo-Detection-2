...
def analyze_chunk_with_gemini(chunk: str) -> str:
    ...
    preset_prompt = (
        ...
        ### Analysis Execution:
        1. Apply Factuality Factors to evaluate the text in a structured manner.
        2. Use Helper Functions to extract claims, verify consistency, and refine findings.
        3. Assign scores (1 to 6) for each sub-factor and calculate an overall score (1 to 6) for each Factuality Factor.
